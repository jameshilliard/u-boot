...
/**
 * enum net_lwip_addr_mode - Initial address configuration for a client
 * @NET_LWIP_ADDR_ENV: Configure the interface from the environment
 * @NET_LWIP_ADDR_NONE: Start with an unconfigured IPv4 interface
 */
