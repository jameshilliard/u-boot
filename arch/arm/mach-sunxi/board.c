...
static int gpio_init(void)
{
	...
	sunxi_gpio_set_pull(SUNXI_GPH(1), SUNXI_GPIO_PULL_UP);
#elif CONFIG_CONS_INDEX == 2 && defined(CONFIG_MACH_SUN50I_H616)
	sunxi_gpio_set_cfgpin(SUNXI_GPG(6), SUN50I_H616_GPG_UART1);
	sunxi_gpio_set_cfgpin(SUNXI_GPG(7), SUN50I_H616_GPG_UART1);
	sunxi_gpio_set_pull(SUNXI_GPG(7), SUNXI_GPIO_PULL_UP);
#elif CONFIG_CONS_INDEX == 3 && defined(CONFIG_MACH_SUN50I_H616)
	sunxi_gpio_set_cfgpin(SUNXI_GPG(15), SUN50I_H616_GPG_UART2);
	sunxi_gpio_set_cfgpin(SUNXI_GPG(16), SUN50I_H616_GPG_UART2);
	sunxi_gpio_set_pull(SUNXI_GPG(16), SUNXI_GPIO_PULL_UP);
#elif CONFIG_CONS_INDEX == 4 && defined(CONFIG_MACH_SUN50I_H616)
	sunxi_gpio_set_cfgpin(SUNXI_GPI(9), SUN50I_H616_GPI_UART3);
	sunxi_gpio_set_cfgpin(SUNXI_GPI(10), SUN50I_H616_GPI_UART3);
	sunxi_gpio_set_pull(SUNXI_GPI(10), SUNXI_GPIO_PULL_UP);
#elif CONFIG_CONS_INDEX == 5 && defined(CONFIG_MACH_SUN50I_H616)
	sunxi_gpio_set_cfgpin(SUNXI_GPI(13), SUN50I_H616_GPI_UART4);
	sunxi_gpio_set_cfgpin(SUNXI_GPI(14), SUN50I_H616_GPI_UART4);
	sunxi_gpio_set_pull(SUNXI_GPI(14), SUNXI_GPIO_PULL_UP);
